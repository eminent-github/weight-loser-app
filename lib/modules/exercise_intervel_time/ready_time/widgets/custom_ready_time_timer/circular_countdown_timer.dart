...
class CircularReadyTimeTimer extends StatefulWidget {
  ...
  */
  ...
  const CircularReadyTimeTimer({
    ...
    this.controller,
    this.supportText,
    required this.startAngleValue,
  }) : assert(initialDuration <= duration);

  @override
  CircularReadyTimeTimerState createState() => CircularReadyTimeTimerState();
}

class CircularReadyTimeTimerState extends State<CircularReadyTimeTimer>
                    ...
                    Positioned.fill(
                      child: CustomPaint(
                        painter: CustomTimerPainter(
                            ...
                            startAngleValue: widget.startAngleValue,
...
class CountDownController {
  CircularReadyTimeTimerState? _state;
  bool? _isReverse;
