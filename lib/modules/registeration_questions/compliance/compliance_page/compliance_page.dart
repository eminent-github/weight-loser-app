...
class CompliancePage extends GetView<ComplianceController> {
                ...
                Column(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    QusTopProgressWidget(
                                      progress: 1 / fifthModuleTotalScreen,
                    ...
                    QusNextButton(
                      ...
                      width: width * 0.5,
                      callBack: () {
                        controller.complianceAnswerApi(
                    ...
                    SizedBox(
                      ...
                      child: QusLinearProgress(
                        width: width * 0.6,
                        height: height * 0.015,
                        progress: 12 / totalScreens,
                        progressText: "${(12 * (100 / totalScreens)).round()}",
                      ),
                    ),
                  ],
                ),
