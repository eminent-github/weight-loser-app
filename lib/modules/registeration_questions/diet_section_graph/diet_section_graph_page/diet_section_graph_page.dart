...
import '../../diet_module_active_lstyle/binding/diet_module_active_lstyle_binding.dart';
import '../../diet_module_active_lstyle/diet_module_active_lstyle_page/diet_module_active_lstyle_page.dart';
import '../../widgets/flip_calender.dart';
import '../../widgets/qus_next_button.dart';
import '../controller/diet_section_graph_controller.dart';

class DietSectionGraphPage extends GetView<DietSectionGraphController> {
  const DietSectionGraphPage({
    super.key,
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    QusNextButton(
                      callBack: () {
                        Get.to(() => const DietModuleActiveStylePage(),
                            binding: DietModuleActiveStyleBinding());
                      },
                      height: height * 0.07,
                      width: width * 0.5,
                    ),
