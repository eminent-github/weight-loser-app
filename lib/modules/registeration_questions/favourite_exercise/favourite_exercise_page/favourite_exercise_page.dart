...
class FavouriteExercisePage extends GetView<FavouriteExerciseController> {
                    ...
                    children: [
                            ...
                            Expanded(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  QusTopProgressWidget(
                                    progress: 1 / thirdModuleTotalScreen,
                        ...
                        child: Center(
                          child: UnderstandWidget(
                            ...
                            requestText: controller.getQuestionWithAnswerModel
                                        .value.response ==
                                    null
                                ? AppTexts.questionFavouriteExerciseTitle
                      ...
                      CustomLargeButton(
                        ...
                        onPressed: () {
                          var list = controller.getQuestionWithAnswerModel.value
                              ...
                              .toList();
                          if (list.length == 3) {
                            controller.favExerciseAnswerApi(
                              controller.getQuestionWithAnswerModel.value
                                  .response!.order!,
                              controller.getQuestionWithAnswerModel.value
                                  .response!.id!,
                            ...
                            customSnackbar(
                                ...
                                message: "Please select any three exercises only");
                          }
                        },
                      ),
                      SizedBox(
                      ...
                      SizedBox(
                        ...
                        child: QusLinearProgress(
                          width: width * 0.6,
                          height: height * 0.015,
                          progress: 6 / totalScreens,
                          progressText: "${(6 * (100 / totalScreens)).round()}",
                        ),
                      ),
                    ],
                  ),
