...
class StressEatingPage extends GetView<StressEatingController> {
  const StressEatingPage({super.key});
                ...
                Column(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    QusTopProgressWidget(
                                      progress: 2 / fifthModuleTotalScreen,
                        ...
                        SizedBox(
                          ...
                          child: UnderstandWidget(
                            ...
                            requestText: controller.getQuestionWithAnswerModel
                                        .value.response ==
                                    null
                                ? AppTexts.qusUnderstandBoredomEatingText
                    ...
                    QusNextButton(
                      ...
                      width: width * 0.5,
                      callBack: () {
                        controller.stressEatingAnswerApi(
                    ...
                    SizedBox(
                      ...
                      child: QusLinearProgress(
                        width: width * 0.6,
                        height: height * 0.015,
                        progress: 13 / totalScreens,
                        progressText: "${(13 * (100 / totalScreens)).round()}",
                      ),
                    ),
                  ],
                ),
