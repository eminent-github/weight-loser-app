...
class StressReponseForEatingPage
    extends GetView<StressResponseForEatingController> {
  const StressReponseForEatingPage({super.key});
                ...
                Column(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    QusTopProgressWidget(
                                      progress: 5 / fifthModuleTotalScreen,
                        ...
                        SizedBox(
                          ...
                          child: UnderstandWidget(
                            ...
                            requestText: controller.getQuestionWithAnswerModel
                                        .value.response ==
                                    null
                                ? AppTexts.qusUnderstandStressEatingText
                    ...
                    QusNextButton(
                      ...
                      width: width * 0.5,
                      callBack: () {
                        controller.stressRespondForEatingAnswerApi(
                    ...
                    SizedBox(
                      ...
                      child: QusLinearProgress(
                        width: width * 0.6,
                        height: height * 0.015,
                        progress: 15 / totalScreens,
                        progressText: "${(15 * (100 / totalScreens)).round()}",
                      ),
                    ),
                  ],
                ),
