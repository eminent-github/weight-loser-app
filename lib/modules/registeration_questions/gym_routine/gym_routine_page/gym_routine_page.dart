...
class GymRoutinePage extends GetView<GymRoutineController> {
  const GymRoutinePage({super.key});
                ...
                Column(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    QusTopProgressWidget(
                                      progress: 3 / thirdModuleTotalScreen,
                        ...
                        SizedBox(
                          ...
                          child: UnderstandWidget(
                            ...
                            requestText: controller.getQuestionWithAnswerModel
                                        .value.response ==
                                    null
                                ? AppTexts.qusUnderstandGymRoutineText
                    ...
                    QusNextButton(
                      ...
                      width: width * 0.5,
                      callBack: () {
                        controller.gymRoutineAnswerApi(
                    ...
                    SizedBox(
                      ...
                      child: QusLinearProgress(
                        width: width * 0.6,
                        height: height * 0.015,
                        progress: 8 / totalScreens,
                        progressText: "${(8 * (100 / totalScreens)).round()}",
                      ),
                    ),
                  ],
                ),
