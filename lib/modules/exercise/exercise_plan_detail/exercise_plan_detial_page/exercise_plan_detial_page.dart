...
import '../widgets/exercise_plan_item.dart';

class ExercisePlanDetialPage extends GetView<ExercisePlanDetialController> {
  const ExercisePlanDetialPage({
    super.key,
              ...
              child: Stack(
                ...
                children: [
                  planImage == null
                      ...
                      : S3LoadingImage(
                          imageUrl:
                              "${ApiUrls.s3ImageBaseUrl}planImages/exercisePlan/$planImage",
                          fit: BoxFit.cover),
                  Container(
