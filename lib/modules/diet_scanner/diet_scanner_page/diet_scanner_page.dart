...
class DietScannerPage extends GetView<DietScannerController> {
  const DietScannerPage({
    super.key,
        ...
        () => Scaffold(
          appBar: AppBar(
            ...
            iconTheme: IconThemeData(
              color: controller.scanningStarted.value
                  ? AppColors.white
                  : AppColors.black,
            ),
            centerTitle: true,
            ...
            systemOverlayStyle: SystemUiOverlayStyle(
              statusBarIconBrightness: controller.scanningStarted.value
                  ? Brightness.light
                  : Brightness.dark,
            ),
                                      ...
                                      : Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Your personal nutritional coach in your pocket',
                                                textAlign: TextAlign.center,
                                                style: AppTextStyles
                                                    .formalTextStyle(
                                                  color: Theme.of(context)
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(16),
                                      child: controller.barcodeSearchedFoodModel
                                                  .value.product!.image ==
                                              null
                                          ? const Center(
                                              child: Icon(
                                      ...
                                      children: [
                                        Padding(
                                          padding: EdgeInsets.only(
                                              left: width * 0.05),
                                          child: AutoSizeText(
                                            controller.barcodeSearchedFoodModel
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButton<String>(
                                          value: controller.foodServing.value,
                                          isExpanded: true,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      CustomLargeButton(
                                        ...
                                        onPressed: () {
                                          if (controller.foodServing.value !=
                                              "Servings") {
