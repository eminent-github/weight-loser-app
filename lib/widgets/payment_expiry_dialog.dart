...
class PaymentExpiryDialog extends StatelessWidget {
  const PaymentExpiryDialog({super.key});
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: SizedBox(
                    height: height * 0.06,
                    child: AutoSizeText(
                      'Renew your plan now to keep using WL! Payment expired.',
