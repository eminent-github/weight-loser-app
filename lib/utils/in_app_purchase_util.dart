  ...
  void _handlePurchaseUpdates(List<PurchaseDetails> purchaseDetailsList) async {
    ...
    for (var purchaseDetails in purchaseDetailsList) {
      ...
      if (purchaseDetails.status == PurchaseStatus.pending) {
        ...
        if (purchaseDetails.productID == "wl_trail_0.99" ||
            purchaseDetails.productID == "wl_trail_2.99" ||
            purchaseDetails.productID == "wl_trail_4.99" ||
            purchaseDetails.productID == "wl_trail_6.99") {
          print("object");
